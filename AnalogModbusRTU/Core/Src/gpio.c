...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, TLC_CS_Pin|RUN_LED_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : TLC_CS_Pin */
  GPIO_InitStruct.Pin = TLC_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(TLC_CS_GPIO_Port, &GPIO_InitStruct);
